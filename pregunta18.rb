...
print "1. Crear un arreglo con las peliculas del mismo genero.: "
pp movies.group_by{|k, v| v[:genre]}

print "2. Contar las peliculas de cada genero. "
pp movies.group_by{|k, v| v[:genre]}.map {|k, v| [k, v.count] }

puts "3. Crear un arreglo con las peliculas que su año se encuentre en un rango."
print "Ingrese año inicial: "
ini = gets.chomp.to_i
print "Ingrese año final: "
fin = gets.chomp.to_i
pp movies.select{|k, v| (ini..fin).cover?(v[:realease_date][-4..-1].to_i) }

puts "4. Segun los votos decir si la pelicula fue: buena, mala, regular."
pp movies.map{|k, v| [k, v[:votes]]}.to_h.map{|k, v| [k, v.count(:good) > v.count(:bad)  ? :Buena : v.count(:good) == v.count(:bad) ? :Regular : :Mala ]}.to_h
